APM
📌 1 - Criação do GitHub e Jira

Criação e configuração do repositório no GitHub

Criação e organização inicial do projeto no Jira

📌 2 - Continuação do Jira e Git utilizando Figma

Atualização e organização das tarefas no Jira
